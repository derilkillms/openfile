...
<body>	
	<style type="text/css"> body { margin: 0; font-family: -apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,"Helvetica Neue",Arial,"Noto Sans",sans-serif,"Apple Color Emoji","Segoe UI Emoji","Segoe UI Symbol","Noto Color Emoji"; font-size: 1rem; font-weight: 400; line-height: 1.5; } input, button { border: none; color: white; padding: 15px 32px; text-align: center; display: inline-block; font-size: 16px; margin: 4px 2px; cursor: pointer; background-color: #e7e7e7; color: black; } input:hover, button:hover { background-color: #f8f8f8; border: 1px solid black; } * { box-sizing: border-box; } *, ::after, ::before { box-sizing: border-box; } ul { list-style-type: none; padding: 0; margin: 0; } ul li { border-bottom: 1px solid #ddd; margin-top: -1px; padding: 12px; } ul span { color: #fff; background-color: #007bff; font-weight: bold; border-radius:20%; padding: 5px 10px; text-align: center; float:right; } a { color: #007bff; text-decoration: none; background-color: transparent; } a:hover { color: -webkit-link; cursor: pointer; text-decoration: underline; } a:not([href]) { color: inherit; text-decoration: none; } textarea.form-control { height: auto; margin:5px; } .form-control { display: block; width: 100%; height: calc(1.5em + 0.75rem + 2px); padding: 0.375rem 0.75rem; font-size: 1rem; font-weight: 400; line-height: 1.5; color: #495057; background-color: #fff; background-clip: padding-box; border: 1px solid #ced4da; border-radius: 0.25rem; transition: border-color .15s ease-in-out,box-shadow .15s ease-in-out; } textarea { overflow: auto; resize: vertical; } .formfile { float: right;margin-right:20%; } @media all and (max-width: 980px){ svg { width: 4%; } input, button { width: 100%; border: none; color: white; padding: 15px 32px; text-align: center; display: inline-block; font-size: 3rem; margin: 4px 2px; cursor: pointer; background-color: #e7e7e7; color: black; } .formfile { width: 100%; float: left; margin-right: 0; } } </style> 
